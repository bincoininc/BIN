...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xd1;  // B
const size_t   CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 10;
const uint64_t CRYPTONOTE_BLOCK_FUTURE_TIME_LIMIT            = DIFFICULTY_TARGET * 7;
const size_t   BLOCKCHAIN_TIMESTAMP_CHECK_WINDOW             = 60;

// MONEY_SUPPLY - total number coins to be generated
const uint64_t MONEY_SUPPLY                                  = UINT64_C(100000000000000000);// UINT64_C(10000000000000000000);
const uint64_t TAIL_EMISSION_REWARD                          = UINT64_C(1000000000000);
const size_t CRYPTONOTE_COIN_VERSION                         = 1;
const unsigned EMISSION_SPEED_FACTOR                         = 35;
...
const uint64_t MINIMUM_FEE                                   = UINT64_C(100000); //UINT64_C(100000000);
const uint64_t DEFAULT_DUST_THRESHOLD                        = UINT64_C(100000); //UINT64_C(100000000);
...
const char     CRYPTONOTE_NAME[]                             = "bincoin";
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff000101029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd08807121011af1ba666c99820cfb42654c87b0b0b994595cf9d515180e851c4c4b7518cac7";
...
const int      P2P_DEFAULT_PORT                              =  20060;
const int      RPC_DEFAULT_PORT                              =  16030;
...
const char* const SEED_NODES[] = { 
  "142.93.55.84:20060",
  "142.93.127.194:20060",
  "142.93.61.142:20060",
  "167.99.153.105:20060",
  "178.128.144.191:20060",
  "142.93.246.232:20060" 
